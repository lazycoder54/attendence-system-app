...
hostname = 'redis-14465.c239.us-east-1-2.ec2.redns.redis-cloud.com'
portnumber = 14465
password = 'Xj4ljY3f1V2LNe97stmRKKATBfdgP86B'
...
# need to save logs for every 1 minute
class RealTimePred:
    def __init__(self):
    ...
    def saveLogs_redis(self):
        ...
        # drop duplicate info  (distinct name)
...
class RegistrationForm:
    ...
    def save_data_in_redis_db(self,name,role):
        ...
        # x_mean = x_mean.tastype(np.float32)
